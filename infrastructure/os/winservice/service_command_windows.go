...
// installService attempts to install the nexelliad service. Typically this should
...
// removeService attempts to uninstall the nexelliad service. Typically this should
...
// startService attempts to Start the nexelliad service.
