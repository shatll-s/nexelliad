...
func (x *NexelliadMessage_GetBalancesByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *NexelliadMessage_GetBalancesByAddressesRequest) fromAppMessage(message *appmessage.GetBalancesByAddressesRequestMessage) error {
...
func (x *NexelliadMessage_GetBalancesByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *NexelliadMessage_GetBalancesByAddressesResponse) fromAppMessage(message *appmessage.GetBalancesByAddressesResponseMessage) error {
	var err *RPCError
