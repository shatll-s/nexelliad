...
const (
	...
	// defaultHalvingPhaseDaaScore is the DAA score after which the pre-halving period
	// switches to the halving period. This number is calculated as follows:
	// We define a year as 365.25 days and a month as 365.25 / 12 = 30.4375
	// secondsPerMonth = 30.4375 * 24 * 60 * 6 = 2 629 800
	// Halving Phase start one year after the first block = 2 629 800 * 12 = 31 557 600

	defaultHalvingPhaseDaaScore = 31557600
