...
import (
	...
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/daawindowstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/shatll-s/nexelliad/domain/consensus/model"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/shatll-s/nexelliad/domain/consensus/processes/parentsmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/pruningproofmanager"
	"github.com/shatll-s/nexelliad/util/staging"
	"github.com/pkg/errors"

	"github.com/shatll-s/nexelliad/domain/prefixmanager/prefix"
	"github.com/shatll-s/nexelliad/util/txmass"

	consensusdatabase "github.com/shatll-s/nexelliad/domain/consensus/database"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/acceptancedatastore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/blockheaderstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/blockrelationstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/blockstatusstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/blockstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/consensusstatestore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/daablocksstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/finalitystore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/multisetstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/pruningstore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/shatll-s/nexelliad/domain/consensus/datastructures/utxodiffstore"
	...
	"github.com/shatll-s/nexelliad/domain/consensus/processes/blockbuilder"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/blockprocessor"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/blockvalidator"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/coinbasemanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/consensusstatemanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/dagtopologymanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/dagtraversalmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/difficultymanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/finalitymanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/ghostdagmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/headersselectedtipmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/mergedepthmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/pastmediantimemanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/pruningmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/reachabilitymanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/syncmanager"
	"github.com/shatll-s/nexelliad/domain/consensus/processes/transactionvalidator"
